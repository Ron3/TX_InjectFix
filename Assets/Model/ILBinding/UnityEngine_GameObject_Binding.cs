...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_GameObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(NodeCanvas.BehaviourTrees.BehaviourTreeOwner)};
            if (genericMethods.TryGetValue("GetComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(NodeCanvas.BehaviourTrees.BehaviourTreeOwner)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            app.RegisterCLRMethodRedirection(method, FindGameObjectsWithTag_10);
            args = new Type[]{typeof(NodeCanvas.Framework.GlobalBlackboard)};
            if (genericMethods.TryGetValue("GetComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(NodeCanvas.Framework.GlobalBlackboard)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* GetComponent_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<NodeCanvas.BehaviourTrees.BehaviourTreeOwner>();
        ...
        static StackObject* FindGameObjectsWithTag_10(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetComponent_11(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<NodeCanvas.Framework.GlobalBlackboard>();
