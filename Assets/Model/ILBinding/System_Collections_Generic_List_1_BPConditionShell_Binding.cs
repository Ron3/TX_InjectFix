...
{
    unsafe class System_Collections_Generic_List_1_BPConditionShell_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<NodeCanvas.Framework.BPConditionShell>);
        ...
        static StackObject* get_Item_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<NodeCanvas.Framework.BPConditionShell> instance_of_this_method = (System.Collections.Generic.List<NodeCanvas.Framework.BPConditionShell>)typeof(System.Collections.Generic.List<NodeCanvas.Framework.BPConditionShell>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Add_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            NodeCanvas.Framework.BPConditionShell @item = (NodeCanvas.Framework.BPConditionShell)typeof(NodeCanvas.Framework.BPConditionShell).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<NodeCanvas.Framework.BPConditionShell>();
