...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            NodeCanvas_Tasks_Actions_BPActionShell_Binding.Register(app);
            NodeCanvas_Framework_ActionTask_Binding.Register(app);
            ETModel_Entity_Binding.Register(app);
            ETModel_ResourcesComponent_Binding.Register(app);
            NodeCanvas_Framework_GraphOwner_1_BehaviourTree_Binding.Register(app);
            NodeCanvas_Framework_GraphOwner_Binding.Register(app);
            System_Collections_Generic_List_1_BPActionShell_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_BPActionShell_ILTypeInstance_Binding.Register(app);
            System_Collections_Generic_List_1_BPConditionShell_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_BPConditionShell_ILTypeInstance_Binding.Register(app);
            System_Collections_Generic_List_1_BPCompositeShell_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_BPCompositeShell_ILTypeInstance_Binding.Register(app);
            System_Collections_Generic_List_1_BPDecoratorShell_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_BPDecoratorShell_ILTypeInstance_Binding.Register(app);
            NodeCanvas_BehaviourTrees_BPCompositeShell_Binding.Register(app);
            NodeCanvas_Framework_Node_Binding.Register(app);
            System_Collections_Generic_List_1_Connection_Binding.Register(app);
            NodeCanvas_Framework_Connection_Binding.Register(app);
            NodeCanvas_Framework_BPConditionShell_Binding.Register(app);
            NodeCanvas_BehaviourTrees_BPDecoratorShell_Binding.Register(app);
            NodeCanvas_Framework_Graph_Binding.Register(app);
            System_Collections_Generic_IEnumerable_1_Graph_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_Graph_Binding.Register(app);
            System_Collections_Generic_IEnumerable_1_BPActionShell_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_BPActionShell_Binding.Register(app);
            System_Collections_Generic_IEnumerable_1_BPConditionShell_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_BPConditionShell_Binding.Register(app);
            System_Collections_Generic_IEnumerable_1_BPCompositeShell_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_BPCompositeShell_Binding.Register(app);
            System_Collections_Generic_IEnumerable_1_BPDecoratorShell_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_BPDecoratorShell_Binding.Register(app);
            ...
            System_Collections_Generic_List_1_GObject_Binding.Register(app);
            System_Math_Binding.Register(app);
            FairyGUI_GComponent_Binding.Register(app);
            System_Collections_Generic_List_1_Dictionary_2_Int32_Int32_Binding.Register(app);
            ...
            FairyGUI_UIContentScaler_Binding.Register(app);
            StringExtention_Binding.Register(app);
            ...
            ETModel_BPAESHelper_Binding.Register(app);
            ...
            NodeCanvas_Framework_IBlackboardExtensions_Binding.Register(app);
            NodeCanvas_Framework_Variable_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_ILTypeInstance_Binding.Register(app);
            NodeCanvas_Framework_Blackboard_Binding.Register(app);
