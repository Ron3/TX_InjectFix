...
// namespace ETModel    // ETModel 里有 Object 类，会有冲突报错
// namespace BPMain
// namespace BPCode
// {
    ...
    public static class BasicValueExtension
    {
        ...
        /// <returns></returns>
        /// // ETModel.AppTypeHelper.Is 和这个 Is 有重复，这里改名为 IsObj
        public static bool IsObj(this object selfObj, object value)
        {
            return selfObj == value;
        }

        // ETModel.AppTypeHelper.Is 和这个 Is 有重复，这里改名为 IsObj
        public static bool IsObj<T>(this T selfObj, Func<T, bool> condition)
        {
